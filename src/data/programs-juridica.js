...
export const programs = [
    ...
    // Maestrías
    {
        ...
        image: "bg-[url('/images/programs/maestria-derecho-penal.webp')] bg-cover bg-center",
    ...
    },
    {
        ...
        image: "bg-[url('/images/programs/maestria-derecho-civil.webp')] bg-cover bg-center",
    ...
    },
    {
        ...
        image: "bg-[url('/images/programs/maestria-derecho-internacional.webp')] bg-cover bg-center",
    ...
    },
    {
        ...
        image: "bg-[url('/images/programs/especialidad-criminalistica.webp')] bg-cover bg-center",
    ...
    // Doctorados
    {
        ...
        image: "bg-[url('/images/programs/doctorado-derecho-procesal.webp')] bg-cover bg-center",
